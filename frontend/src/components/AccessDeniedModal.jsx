    ...
    >
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          boxShadow:
            "0 24px 80px rgba(224,82,82,0.15), 0 0 0 1px rgba(224,82,82,0.08)",
        }}
      >
        {/* Red top bar */}
        <div
          style={{
            height: "3px",
            background:
              "linear-gradient(90deg, var(--color-error), transparent)",
          }}
        />
        ...
        <div className="p-8">
          ...
          >
            {message ||
              "The credentials you entered are incorrect. You do not have access to this system."}
          </p>
