...
const InputField = ({ id, label, type = 'text', value, onChange, error, placeholder, icon, rightElement }) => (
  <div style={{ marginBottom: '18px' }}>
    ...
    {error && (
      <p style={{ color: 'var(--color-error)', fontSize: '0.75rem', marginTop: '5px' }}>{error}</p>
    )}
  </div>
)
    ...
    try {
      ...
      if (err.response?.data?.errors) {
        ...
        Object.keys(e).forEach(key => {
          serverErrors[key] = Array.isArray(e[key]) ? e[key][0] : e[key]
        })
    ...
    >
      ...
      >
        ...
        <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', opacity: 0.035 }} preserveAspectRatio="none">
          {[...Array(10)].map((_, i) => (
            <line key={i} x1={`${i * 15 - 50}%`} y1="0" x2={`${i * 15 + 50}%`} y2="100%"
        ...
        <div className="animate-fade-in-up" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="flex items-center gap-3 mb-12">
            <div style={{
              ...
              <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.5">
                <rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>
              </svg>
            </div>
            <span style={{
          ...
          <h1 style={{
            ...
            color: 'var(--color-text-primary)', marginBottom: '18px',
          }}>
            Create Your<br />
          ...
          <p style={{
            ...
            Register to gain access to the Nexus system. All accounts are subject to administrator approval.
          </p>
        </div>

        {/* Steps */}
        <div className="animate-fade-in-up delay-200" style={{ position: 'relative', zIndex: 1 }}>
          {[
            ...
            <div key={i} className="flex items-center gap-4 mb-5">
              <span style={{
                ...
                fontWeight: 700, color: 'var(--color-accent)', minWidth: '28px',
              }}>{item.step}</span>
              <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--color-border)' }} />
              <span style={{ color: 'var(--color-text-secondary)', fontSize: '0.85rem' }}>{item.label}</span>
            </div>
          ))}
        </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            <div style={{
              width: '30px', height: '30px', border: '1px solid var(--color-accent)',
          ...
          <div className="animate-fade-in-up" style={{ marginBottom: '28px' }}>
            ...
            <h2 style={{
              ...
              fontWeight: 700, color: 'var(--color-text-primary)', marginBottom: '6px',
            }}>Register</h2>
          ...
          {errors.general && (
            <div className="animate-fade-in" style={{
              ...
              marginBottom: '18px', fontSize: '0.85rem',
          ...
          <form onSubmit={handleSubmit} noValidate>
            {/* Name row */}
            <div className="animate-fade-in-up delay-100" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <InputField
                id="first_name" label="First Name"
                value={form.first_name} onChange={handleChange}
                error={errors.first_name} placeholder="John"
                icon={userIcon}
              />
              <InputField
            ...
            <div className="animate-fade-in-up delay-200">
              <InputField
                ...
                error={errors.username} placeholder="johndoe"
                icon={userIcon}
              />
            </div>
            ...
            {/* Password row */}
            <div className="animate-fade-in-up delay-300" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <InputField
              ...
              />
              <InputField
                id="password2" label="Confirm"
                type={showPass2 ? 'text' : 'password'}
                value={form.password2} onChange={handleChange}
                error={errors.password2} placeholder="Repeat"
                icon={lockIcon}
                rightElement={
            ...
            {/* Submit */}
            <div className="animate-fade-in-up delay-400" style={{ marginTop: '8px' }}>
              <button
                type="submit"
                ...
                style={{
                  ...
                  color: (loading || success) ? 'var(--color-text-muted)' : '#0a0c10',
                ...
                {loading ? (
                  <>
                    <div className="animate-spin-custom" style={{
                      ...
                      borderTopColor: 'var(--color-text-muted)', borderRadius: '50%',
                    }} />
                    Creating account...
                  </>
                ) : success ? (
          ...
          <p className="animate-fade-in-up delay-400" style={{
            ...
            color: 'var(--color-text-muted)', fontSize: '0.75rem', lineHeight: 1.6,
          }}>
            By registering, you agree to the system's terms of use.<br />
